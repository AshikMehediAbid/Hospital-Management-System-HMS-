								...
								<div class="col-md-3 my-2 bg-info mx-2" style="height:150px;">
									...
									<div class="col-md-12">
										<div class="row">
											...
											<div class="col-md-4">
												<a href="profile.php"><i class="fa fa-user-circle fa-3x my-4" style="color:white;"></a>
								...
								<div class="col-md-3 my-2 bg-warning mx-2" style="height:150px;">
									...
									<div class="col-md-12">
										<div class="row">
											...
											<div class="col-md-4">
												<a href="#"><i class="fa fa-procedures fa-3x my-4" style="color:white;"></a>
								...
								<div class="col-md-3 my-2 bg-success mx-2" style="height:150px;">
									...
									<div class="col-md-12">
										<div class="row">
											...
											<div class="col-md-4">
												<a href="#"><i class="fa fa-calendar fa-3x my-4" style="color:white;"></a>
