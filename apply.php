...
if(isset($_POST['apply'])){
	...
	{
		$error['apply'] = 'Confirm Password do not match' ;
	}


	if(count($error) ==0 )
	{
		$query = "INSERT INTO doctors(firstname,surname,username, email,gender,phone,password,salary,date_reg,status,profile) VALUES('$firstname','$surname','$username','$email','$gender','$phone','$password','0',NOW(),'Pending','doctor.jpg') ";
			...
			<div class="row">
				...
				<div class="col-md-6 my-3 jumbotron">
					...
					<form method="post">
						...
						<input type="submit" name="apply" value="Submit" class="btn btn-success">

						<p><a href="doctorlogin.php">Already have an account</a></p>
